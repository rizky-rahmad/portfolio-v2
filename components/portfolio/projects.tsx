...
const featuredProjects = [
  {
    ...
    description: "Managed platform for BPSDM Aceh with multi-role RBAC, audit logs, and automated ticket dispatching. A comprehensive system for handling institutional complaints efficiently.",
    image: "/images/projects/sikemas.jpg",
    liveUrl: "https://sikemasbpsdm.web.id",
    stack: ["React (Vite)", "Bootstrap 5", "Node.js", "Express", "PostgreSQL", "JWT", "Google OAuth 2.0"],
    featured: true,
  },
  {
    title: "Attendance System - Online Platform",
    description: "Full-stack engine with server-side filtering and geolocation check-in validation for large employee datasets. Built for scalability and reliability.",
    image: "/images/projects/attendance.jpg",
    stack: ["React (Vite)", "Bootstrap 5", "Node.js", "Express", "PostgreSQL", "JWT"],
    featured: true,
  },
  {
    title: "To-Do List App - Persistent Task Management",
    description: "Persistent web application utilizing server-side rendering (EJS) and PostgreSQL database integration for reliable task management.",
    image: "/images/projects/todo.jpg",
    githubUrl: "https://github.com/rizky-rahmad",
  ...
  return (
    <section id="projects" className="py-20 sm:py-32 relative overflow-hidden bg-secondary/20">
      ...
      <div className="absolute inset-0 -z-10">
        ...
        <div className="absolute bottom-1/4 left-0 w-[600px] h-[600px] bg-primary/3 rounded-full blur-3xl" />
      </div>
      ...
      <div ref={ref} className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="mt-4 text-muted-foreground text-lg max-w-2xl mx-auto text-pretty">
            A selection of production-ready projects showcasing full-stack development expertise and real-world problem solving.
          </p>
        </motion.div>
